...
- [ ] Attribute names in the text differe from tables and figures e.g. "Succesful Reception" I suggest you create a table with abbreviation mapping, but in reality you should changethem in your tables and figues. The way to do this is to ad a column in your df and than when you plot the data use them
